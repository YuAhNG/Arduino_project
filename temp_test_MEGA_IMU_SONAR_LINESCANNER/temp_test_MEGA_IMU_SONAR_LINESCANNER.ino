...
void loop() {
  ...
  a[7]  = a[6];
  a[8]  = coef_digitalread * (1 - digitalRead(backward_pin0));
  a[9]  = coef_digitalread * (1 - digitalRead(backward_pin1));
  a[10] = coef_digitalread * (1 - digitalRead(backward_pin2));
  a[11] = coef_digitalread * (1 - digitalRead(backward_pin3));
  a[12] = coef_digitalread * (1 - digitalRead(backward_pin4));
  a[13] = coef_digitalread * (1 - digitalRead(backward_pin5));
  a[14] = coef_digitalread * (1 - digitalRead(backward_pin6));
  a[15] = coef_digitalread * (1 - digitalRead(backward_pin7));
